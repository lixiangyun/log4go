...
```go get github.com/lixiangyun/log4go```

Then import it to your project.

```import log "github.com/lixiangyun/log4go"```
...
Thanks alecthomas for providing the [original resource](https://github.com/lixiangyun/log4go).
